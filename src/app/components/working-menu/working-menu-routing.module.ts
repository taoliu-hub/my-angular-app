...
import { WorkingWithEchartsComponent } from './working-with-echarts/working-with-echarts.component';
...
const routes: Routes = [
  ...
  { path: 'woring-with-echarts', canActivate: [AuthGuard], component: WorkingWithEchartsComponent,
    loadChildren: () => import('./working-with-echarts/working-with-echarts.module').then(m => m.WorkingWithEchartsModule), //异步加载、惰性加载、懒加载
  },
