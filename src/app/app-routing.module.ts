...
const routes: Routes = [
  { path: '', pathMatch: 'full', redirectTo: '/angular-guide/welcome' },
  { path: 'angular-guide', loadChildren: () => import('./components/angular-guide/angular-guide.module').then(m => m.AngularGuideModule) },
